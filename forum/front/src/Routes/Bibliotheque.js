                ...
                <div className="section">
                    <div className="row">
                        <div className="col s12 m6 l4">
                            <div className="card">
                                <div className="card-image">
                                    <img src="images/bibliotheque/pexels-ivan-samkov-7213438.jpg" />
                        ...
                        <div className="col s12 m6 l4">
                            <div className="card">
                                <div className="card-image">
                                    <img src="images/bibliotheque/pexels-kaique-rocha-598917_2.jpg" />
                        ...
                        <div className="col s12 m6 l4">
                            <div className="card">
                                <div className="card-image">
                                    <img src="images/bibliotheque/pexels-pixabay-276452_2.jpg" />
                        ...
                        <div className="col s12 m6 l4">
                            <div className="card">
                                <div className="card-image">
                                    <img src="images/bibliotheque/pexels-thisisengineering-3862372_2.jpg" />
                        ...
                        <div className="col s12 m6 l4">
                            <div className="card">
                                <div className="card-image">
                                    <img src="images/bibliotheque/pexels-tirachard-kumtanom-733853_2.jpg" />
                        ...
                        <div className="col s12 m6 l4">
                            <div className="card">
                                <div className="card-image">
                                    <img src="images/bibliotheque/pexels-tranmautritam-326502_2.jpg" />
